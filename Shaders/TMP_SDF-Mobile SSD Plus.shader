...
Shader "TextMeshPro/Mobile/Distance Field SSD Plus" {
...
SubShader {
	...
	Pass {
		...
		pixel_t VertShader(vertex_t input)
		{
		    ...
		    float4 outlineColor = input.tangent;
		    ...
		    output.param = float4(0.5 - weight, 1.3333 * _GradientScale * (_Sharpness + 1) / _TextureWidth, outlineWidth * scaleRatioA * 0.5, 0);
